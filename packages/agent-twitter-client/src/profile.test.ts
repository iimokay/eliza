...
test('scraper can get screen name by user id', async () => {
    ...
    const screenName = await scraper.getScreenNameByUserId(
        '1586562503865008129',
    );
...
test('scraper can get profile', async () => {
    const expected: Profile = {
        avatar: 'https://pbs.twimg.com/profile_images/436075027193004032/XlDa2oaz.jpeg',
...
test('scraper can get partial private profile', async () => {
    const expected: Profile = {
        avatar: 'https://pbs.twimg.com/profile_images/1612213936082030594/_HEsjv7Q.jpg',
