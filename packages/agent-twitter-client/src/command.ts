...
async function executeCommand(commandLine: string) {
    ...
    switch (command) {
        ...
        case 'get-tweets':
            ...
            if (!username) {
                ...
                try {
                    ...
                    console.log(
                        `Fetched ${tweets.length} tweets from @${username}:`,
                    );
        ...
        case 'get-mentions':
            ...
            try {
                ...
                for (const mention of mentions) {
                    ...
                    replies.forEach((reply) => {
                        console.log(
                            `- [${reply.id}] @${reply.username}: ${reply.text}`,
                        );
                    });
                }
            } catch (error) {
        ...
        case 'help':
            ...
            console.log(
                '  retweet <tweetId>         - Retweet a tweet by its ID',
            );
            console.log(
        ...
        case 'retweet':
            ...
            if (!retweetId) {
                ...
                try {
                    ...
                    console.log(
                        `Tweet ID ${retweetId} retweeted successfully.`,
                    );
                } catch (error) {
        ...
        case 'follow':
            ...
            if (!usernameToFollow) {
                ...
                try {
                    ...
                    console.log(
                        `Successfully followed user @${usernameToFollow}.`,
                    );
                } catch (error) {
...
async function sendLongTweetCommand(
    ...
    try {
        ...
        const responseData = await response.json();
        const tweetId =
            responseData?.data?.notetweet_create?.tweet_results?.result
                ?.rest_id;
